...
[http-verb-decorators]: ../rest/decorators#http-verb-decorators
[http-route-decorator]: ../rest/decorators#routing
...
[http-parameter-decorators]: ../rest/decorators#data-types
[http-body-decorator]: ../rest/decorators#body
...
[http-statuscode-decorator]: ../rest/decorators#statuscode
...
If the Cadl operation has an [(OpenAPI) `@externalDocs` decorator](./decorators#externaldocs) this will produce
an externalDocs field in the OpenAPI operation.

### Specification extensions

Any extensions specified on the Cadl operation with the [(OpenAPI) `@extension` decorator](./decorators#extension)
